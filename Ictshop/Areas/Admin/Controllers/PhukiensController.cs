...
namespace Ictshop.Areas.Admin.Controllers
{
    public class PhukiensController : Controller
    {
        ...
        public ActionResult Index(int? page)
        {
            ...
            var sp = db.Sanphams
                .Where(x => x.NhomSanPham.Contains("PhuKien"))
                .OrderBy(x => x.Masp);
        ...
        public ActionResult Create([Bind(Include = "Masp,Tensp,Giatien,Soluong,Mota,Anhbia,Tuongthich,LoaiKetNoi,CongSuat,KichCo,MauSac,Tenhangsx,NhomSanPham,LoaiSanPham,Thongtinkhac")] Sanpham sanpham)
        {
        ...
        public ActionResult Edit(Sanpham sanpham)
        {
            try
            {
                ...
                if (oldItem != null)
                {
                    ...
                    oldItem.Tuongthich = sanpham.Tuongthich;
                    oldItem.LoaiKetNoi = sanpham.LoaiKetNoi;
                    oldItem.CongSuat = sanpham.CongSuat;
