...
{
    public class SanphammaytinhsController : Controller

    {
        Qlbanhang db = new Qlbanhang();

        // GET: Admin/Sanphammaytins
        ...
        public ActionResult Index(int? page)
        {
            ...
            var sp = db.Sanphams
                .Where(x => x.NhomSanPham.Contains("LaptopPC"))
                .OrderBy(x => x.Masp);
        ...
        public ActionResult Create([Bind(Include = "Masp,Tensp,Giatien,Soluong,Mota,RAM,Dungluong,Sanphammoi,Mahang,Mahdh,ChipCPU,GPU,KetNoi,Anhbia,Pin,Manhinh,Trongluong,Kichthuoc,Mainboard,Nguon,Tannhiet,LoaiCase,Thongtinkhac,Tenhangsx,Tenhedieuhanh,NhomSanPham,LoaiSanPham")] Sanpham sanpham)
        {
        ...
        public ActionResult Edit(Sanpham sanpham)
        {
            try
            {
                ...
                if (oldItem != null)
                {
                    ...
                    oldItem.Dungluong = sanpham.Dungluong;
                    oldItem.Sanphammoi = sanpham.Sanphammoi;
                    oldItem.ChipCPU = sanpham.ChipCPU;
                    oldItem.Mahang = sanpham.Mahang;
                    oldItem.Mahdh = sanpham.Mahdh;
                    oldItem.GPU = sanpham.GPU;
                    oldItem.Ketnoi = sanpham.Ketnoi;
                    oldItem.Pin = sanpham.Pin;
                    oldItem.Manhinh = sanpham.Manhinh;
                    //oldItem.Camera = sanpham.Camera;
                    oldItem.Mainboard = sanpham.Mainboard;
                    oldItem.Nguon = sanpham.Nguon;
                    oldItem.Tannhiet = sanpham.Tannhiet;
                    oldItem.LoaiCase = sanpham.LoaiCase;
                    //oldItem.SocketPC = sanpham.SocketPC;
                    //oldItem.Quat = sanpham.Quat;
                    oldItem.Trongluong = sanpham.Trongluong;
                    oldItem.Kichthuoc = sanpham.Kichthuoc;
                    oldItem.Thongtinkhac = sanpham.Thongtinkhac;
                    oldItem.Tenhangsx = sanpham.Tenhangsx;
                    oldItem.Tenhedieuhanh = sanpham.Tenhedieuhanh;
