...
namespace Ictshop.Areas.Admin.Controllers
{
        ...
        
    {
        ...
        public ActionResult Index(int ?page)
        {
            ...
            var sp = db.Sanphams
            .Where(x => x.NhomSanPham.Contains("PhoneTablet"))
            .OrderBy(x => x.Masp);
        ...
        //public ActionResult Create([Bind(Include = "Masp,Tensp,Giatien,Soluong,Mota,Thesim,Dungluong,Sanphammoi,RAM,Anhbia,Mahang,Mahdh,Manhinh,Camera,Pin,ChipCPU,Ketnoi,Chatlieu,Trongluong,Kichthuoc,Thongtinkhac,Tenhangsx,Tenhedieuhanh,NhomSanPham,LoaiSanPham")] Sanpham sanpham)
        public ActionResult Create([Bind(Include = "Masp,Tensp,Giatien,Soluong,Mota,Thesim,Dungluong,Sanphammoi,RAM,Anhbia,Mahang,Mahdh,Manhinh,Camera,Pin,ChipCPU,Ketnoi,Thongtinkhac,Tenhangsx,Tenhedieuhanh,NhomSanPham,LoaiSanPham")] Sanpham sanpham)
        {
