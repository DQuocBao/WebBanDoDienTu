...
namespace Ictshop.Controllers
{
    public class GioHangController : Controller
    {
        ...
        //Thêm giỏ hàng
        [HttpPost]
        public ActionResult ThemGioHang(int iMasp, int? quantity, string strURL)
        {
            if (iMasp == 0)
            {
                return HttpNotFound();
            ...
            // Mặc định số lượng là 1 nếu không có giá trị
            int soLuong = quantity ?? 1;
            ...
            if (sanpham == null)
            {
                ...
                sanpham.iSoLuong = soLuong; // Gán số lượng nhập từ form
                //Add sản phẩm mới thêm vào list
                lstGioHang.Add(sanpham);
            }
            else
            {
                sanpham.iSoLuong += soLuong; // Cộng dồn số lượng nhập vào
            }
